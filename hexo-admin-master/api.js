  ...
  if (type === 'poule') {
    ...
    while (matchNumber > 1) {
      ...
      for (let i = 0; i < matchNumber; i += 2) {
        ...
        }else{console.log(matches.find(m => m.round === roundTab[roundTab.indexOf(currentRound) - 1] && !roundMatches.some((match) => match.team1 === m._id||match.team2 === m._id)))
